...
export class MeetVerseCluster extends pulumi.ComponentResource {
    ...
    constructor(adminEmail: string, repository: Repository, webHostname: string, diskSize: number | undefined) {
        ...
        apply(([ name, endpoint, masterAuth ]) => {
            ...
            return compiled( {certificate: masterAuth.clusterCaCertificate, endpoint: endpoint, context: context} );
        });
        ...
        new MeetverseChart(clusterProvider, repository, nginx.annotations, webHostname)
    }
}
